...
#define TOKEN               "ESP32_DEMO_TOKEN_Prueba1"
...
*/
  ...
  if (send_passed > send_delay) {
    ...
    //} else {
      ...
      tb.sendTelemetryFloat("temperatura Ext", tempExt);
      tb.sendTelemetryFloat("temperatura Int", tempInt);
      tb.sendTelemetryFloat("Diferencia de temperatura", difTemp);
